    ...
    Array.from(m).forEach(function (e) {
      ...
      'flatpickr' == e.getAttribute('data-provider')
        ? ((t = {}),
          ...
          o['data-enable-time'] &&
            ((t.enableTime = !0), (t.dateFormat = o['data-date-format'].value.toString() + ' H:i')),
          o['data-altFormat'] && ((t.altInput = !0), (t.altFormat = o['data-altFormat'].value.toString())),
          o['data-minDate'] &&
            ((t.minDate = o['data-minDate'].value.toString()), (t.dateFormat = o['data-date-format'].value.toString())),
          o['data-maxDate'] &&
            ((t.maxDate = o['data-maxDate'].value.toString()), (t.dateFormat = o['data-date-format'].value.toString())),
          o['data-deafult-date'] &&
